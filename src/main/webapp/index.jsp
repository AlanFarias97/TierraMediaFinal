            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        <h2>Tierra Media es un parque temÃ¡tico basado en los libros de J.R.R. Tolkien</h2>
                        ...
                        <p>PodrÃ¡s disfrutar de aquellos lugares donde siempre quisiste estar mientras leÃ­as "El Hobbit" o "El Silmarillon". VÃ©n a conocer El Reino de Gondor, Mordor, Erebor, Rohan o su amado Abismo de Helm</p>
                    </div>
                </div>
                <div class="col-lg-7">
