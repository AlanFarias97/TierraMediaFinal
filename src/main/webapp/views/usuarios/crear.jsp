				...
				<form action="/turismo/admin-usuarios/crear" method="post">
					<div class="modal-body">
						...
						<div class="mb-3">
							...
							<input class="form-control" type="number" id="monedas"
								name="monedas" required></input>
							<div class="invalid-feedback">
						...
						<div class="mb-3">
							...
							<input class="form-control" type="number" id="tiempo"
								name="tiempo" required></input>
							<div class="invalid-feedback">
						...
						<div class="mb-3">
							<label for="admin" class='col-form-label'>¿Es
								administrador?:</label> <input class="form-control" type="text"
								id="admin" name="admin" required></input>
						</div>
