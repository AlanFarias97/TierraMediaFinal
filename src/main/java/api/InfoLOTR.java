...
public class InfoLOTR {
	...
	public static Frases getInfo() throws IOException, InterruptedException {
	...
	public static Personajes getAutor(String autorId) throws IOException, InterruptedException {
